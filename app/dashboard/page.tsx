...
// ---- on-chain / subgraph utils (dari code logika pertama) ----
...
// ---------------- Types ----------------
type BidStatusUI = "winning" | "outbid" | "won" | "lost";
...
export default function DashboardPage() {
  ...
  // ---- Mock user stats / collections / submissions (bisa ganti ke data nyata nanti) ----
  const userStats = {
    totalBids: 23,
    wonAuctions: 5,
    totalSpent: 45.7,
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      await fetchPendingReturnsAmount();
    } catch (err: any) {
  ...
  const fetchPendingReturnsAmount = async () => {
    if (account) {
      ...
      >
        ...
        <Card className="w-full max-w-md bg-white/[0.05] border border-white/10 backdrop-blur-sm">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-slate-300/85 mb-6">Connect your wallet to access your dashboard and manage your auctions.</p>

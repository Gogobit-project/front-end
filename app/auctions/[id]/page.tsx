...
// import { Clock, TrendingUp, Users, Shield, ChevronLeft, ExternalLink, Calendar, Globe, History, Gavel, AlertCircle, CheckCircle, Loader2 } from "lucide-react";
...
//           currentBid: onchainData.highestBid,
//           bidders: onchainData.highestBidder !== ethers.ZeroAddress ? 1 : 0,
//           timeLeft: onchainData.endTime,
...
//       const diff = auction.timeLeft.getTime() - Date.now();
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  // params sekarang async (Next.js 15+)
  // jadi harus ditunggu sebelum dipakai
  return <AuctionDetailPage tokenId={(await params).id} />;
}
